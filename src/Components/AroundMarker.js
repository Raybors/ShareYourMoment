...
export class AroundMarker extends React.Component {
    // require props (AroundMap) send a position to AroundMarker
    // if not received, return error (Using propTypes)
    static propTypes = {
    ...
    render() {
        const { location, message, url, user, type } = this.props.post;
